# INIT ALL OVER
source('../read-write-met-data/R_readMetData.r')
source('../PlayingCodes/climStat.r')
outFo <- '/home/olivier/Desktop/TMP'
inGCM <- '/home/olivier/Desktop/Wine-shared/Projects/2015-2016_AgMIP2/ZIM-CLIP/ZIM-Baselines/ZWNK0XXX.AgMIP'
loc <- 'test'
...
plotTemp <- function(metD,quaTmn,quaTmx,figTit,outFi)
{
	...
	axis(1,	at=c(1,31,59,90,120,151,181,212,243,273,304,334,365),
